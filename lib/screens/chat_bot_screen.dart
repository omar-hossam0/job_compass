...
class _ChatBotScreenState extends State<ChatBotScreen> {
  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        text:
            "Hello! I'm your Job Compass assistant. Ask me anything about jobs, applications, or career advice!",
        isUser: false,
  ...
  String _getMockResponse(String message) {
    ...
    if (lowerMessage.contains('job') ||
        lowerMessage.contains('position') ||
        lowerMessage.contains('وظيفة') ||
        lowerMessage.contains('عمل')) {
    ...
    // Application process
    if (lowerMessage.contains('apply') ||
        lowerMessage.contains('application') ||
        lowerMessage.contains('تقديم') ||
    ...
    if (lowerMessage.contains('cv') ||
        lowerMessage.contains('resume') ||
        lowerMessage.contains('السيرة الذاتية') ||
    ...
    // Remote work
    if (lowerMessage.contains('remote') ||
        lowerMessage.contains('work from home') ||
        lowerMessage.contains('wfh') ||
        lowerMessage.contains('hybrid') ||
        lowerMessage.contains('بعد') ||
    ...
    // Career change
    if (lowerMessage.contains('career change') ||
    ...
    // Cover letter
    if (lowerMessage.contains('cover letter') ||
        lowerMessage.contains('cover') ||
        lowerMessage.contains('خطاب') ||
        lowerMessage.contains('motivation')) {
    ...
    if (lowerMessage.contains('linkedin') ||
        lowerMessage.contains('network') ||
        lowerMessage.contains('connect') ||
        lowerMessage.contains('شبكة')) {
    ...
    if (lowerMessage.contains('offer') ||
        lowerMessage.contains('accept') ||
        lowerMessage.contains('decline') ||
        lowerMessage.contains('عرض')) {
    ...
    if (lowerMessage.contains('first day') ||
        lowerMessage.contains('new job') ||
        lowerMessage.contains('start') ||
        lowerMessage.contains('اول يوم')) {
    ...
    if (lowerMessage.contains('balance') ||
        lowerMessage.contains('burnout') ||
        lowerMessage.contains('stress') ||
        lowerMessage.contains('توازن')) {
    ...
    if (lowerMessage.contains('portfolio') ||
        ...
        lowerMessage.contains('showcase') ||
        lowerMessage.contains('معرض')) {
    ...
    if (lowerMessage.contains('career') ||
        ...
        lowerMessage.contains('guidance') ||
        lowerMessage.contains('مهني') ||
        lowerMessage.contains('نصيحة') ||
        ...
        children: [
          ...
          Flexible(
            child: Container(
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: message.isUser ? const Color(0xff3F6CDF) : Colors.white,
